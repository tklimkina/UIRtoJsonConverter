...
#define VAL_64BIT_INTEGER               9L
#define VAL_UNSIGNED_64BIT_INTEGER      10L
#define VAL_NO_TYPE                     11L    /* for internal use only */
...
#define VAL_MOVE_CURSOR                 28L
    ...
    /*** graph zoom styles (for ATTR_ZOOM_STYLE): ***/
#define VAL_ZOOM_AROUND_PT              0
#define VAL_ZOOM_TO_RECT                1
#define VAL_ZOOM_XAXIS                  2
#define VAL_ZOOM_YAXIS                  3
...
#define VAL_RIGHT_YAXIS     2               /* for graphs and strip charts */
...
/*** used to specify the default image for built-in control menu sitems when calling SetCtrlMenuAttribute with ATTR_ITEM_BITMAP **/
#define VAL_DEFAULT_IMAGE               -1

/*** values for built-in control menu ids */
#define VAL_GOTO                        -2      /* table */
#define VAL_FIND                        -3      /* table, tree */
#define VAL_SEARCH                      VAL_FIND/* table, tree */
...
#define VAL_PLOT_COLOR                  -9      /* graph */
#define VAL_PLOT_STYLE                  -10     /* graph */
#define VAL_PLOT_POINT_STYLE            -11     /* graph */
#define VAL_PLOT_LINE_STYLE             -12     /* graph */
#define VAL_PLOT_BGCOLOR                -13     /* graph */
#define VAL_PLOT_ORIGIN                 -14     /* graph */
#define VAL_PLOT_FONT                   -15     /* graph */
#define VAL_PLOT_FILL_COLOR             -16     /* graph */
#define VAL_PLOT_VISIBLE                -17     /* graph */
#define VAL_PLOT_RENAME                 -18     /* graph */
#define VAL_PLOT_LINE_THICKNESS         -19     /* graph */
#define VAL_FIND_NEXT                   -20     /* table, tree */
#define VAL_FIND_PREV                   -21     /* table, tree */
...
/*** values for eventData2 for some graph events ***/
#define VAL_CURSOR                      1
#define VAL_ANNOTATION                  2
...
#define EVENT_PANEL_SIZING              37  /* eventData1 = sizing edge (PANEL_SIZING_TOPLEFT, etc) */
                                            /* eventData2 = pointer to panel rect */
...
#define EVENT_TABLE_ROW_COL_LABEL_CLICK 43  /* eventData1 = row */
                                            /* eventData2 = col */
...
#define COLUMN_LABEL_CLICK          5
   ...
   /* Event specifiers for EVENT_MOUSE_WHEEL_SCROLL */
...
#define PANEL_SIZING_TOPLEFT        1
#define PANEL_SIZING_TOP            2
#define PANEL_SIZING_TOPRIGHT       3
#define PANEL_SIZING_RIGHT          4
#define PANEL_SIZING_BOTTOMRIGHT    5
#define PANEL_SIZING_BOTTOM         6
#define PANEL_SIZING_BOTTOMLEFT     7
#define PANEL_SIZING_LEFT           8

   /* Event specifiers for EVENT_ZOOM */
#define ZOOM_IN                     1
#define ZOOM_OUT                    2
#define ZOOM_PAN                    3
#define ZOOM_RESTORE                4

   /* Event specifiers for EVENT_END_TASK */
#define APP_CLOSE                   0
#define SYSTEM_CLOSE                1

#define LoWord(x)                   ((short)(x))
#define HiWord(x)                   ((short)((int)(x)>>16))


    /*** TIF Image Compression Formats ***/
#define TIF_COMPRESSION_NONE        0
#define TIF_COMPRESSION_RLE         1
#define TIF_COMPRESSION_JPEG        2
#define TIF_COMPRESSION_ZIP         3
...
typedef enum
{
    ...
    UIEImageFeatureNotSupported                                 = -166,
    UIEImageCompressionSchemeNotSupported                       = -167,
    UIEActiveXCtrlNotLicensed                                   = -168,
    UIEMXBFileFormatNotRecognized                               = -169,
    UIEAttrValidOnMenuItemAndSubmenuOnly                        = -170,
    UIECannotAssignContextMenuItemShortcutKey                   = -171,
    UIECannotPauseUnlessContinuousMode                          = -172,
    UIEErrorLimit                                               = -173
} UIError;
...
int CVIFUNC_C SetTraceAttributeEx(int panel, int control, int traceNum,
                              int attribute, ...);
...
int CVIFUNC SetKeyPressEventKey(int eventData2, int virtualKey,
    ...
    /*** panel sizing and moving handling functions ***/
int CVIFUNC GetPanelEventRect (int eventData2, Rect *r);
int CVIFUNC SetPanelEventRect (int eventData2, Rect r);
...
int CVIFUNC CreateMetaFontEx(const char *name, const char *fontName, int size, int bold,
                             int italic, int underline, int strikeout, int angle);
...
int     CVIFUNC SaveBitmapToTIFFile(int bitmap, const char fileName[], int compression);
...
int     CVIFUNC GetCtrlMenuAttribute (int panel, int control, int menuItem, int attribute,
    ...
    /***********************************/
int     CVIFUNC SetNumericColorRamp(int panel, int control, ColorMapEntry colorMapArray[], 
                                    int hiColor, int numColors, int interpColors);
int     CVIFUNC GetNumericColorRamp(int panel, int control, ColorMapEntry colorMapArray[], 
                                    int *hiColor, int *interpColors);
int     CVIFUNC DiscardNumericColorRamp(int panel, int control);
