...
#define _getmbcp()      (_MB_CP_SBCS)
#define _ismbblead(c)   (0)
#define _mbsbtype(c,l)  (_MBC_SINGLE)
#define _mbsdec(p,s)    ((((unsigned char *)(p)) < ((unsigned char *)(s))) \
                            ? (((unsigned char *)(s))-1)                   \
                            :  ((unsigned char *)(0)))
#define _mbsinc(s)      (((unsigned char *)(s))+1)
#define _mbscmp         strcmp
#define _mbsicmp        strcasecmp
#define _mbsnbcmp       strncmp
#define _mbsnbicmp      strncasecmp
